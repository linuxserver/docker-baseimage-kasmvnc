          ...
          retry_backoff(5,5) {
            sh '''#! /bin/bash
                  ...
                  for PUSHIMAGE in "${GITHUBIMAGE}" "${GITLABIMAGE}" "${QUAYIMAGE}" "${IMAGE}"; do
                    ...
                    docker buildx imagetools create -t ${PUSHIMAGE}:debianbullseye ghcr.io/linuxserver/jenkins-builder:empty || true
        ...
        withCredentials([
          ...
          retry_backoff(5,5) {
            sh '''#! /bin/bash
                  ...
                  for MANIFESTIMAGE in "${IMAGE}" "${GITLABIMAGE}" "${GITHUBIMAGE}" "${QUAYIMAGE}"; do
                    docker buildx imagetools create -t ${MANIFESTIMAGE}:debianbullseye -t ${MANIFESTIMAGE}:amd64-debianbullseye -t ${MANIFESTIMAGE}:arm64v8-debianbullseye ghcr.io/linuxserver/jenkins-builder:empty || true
